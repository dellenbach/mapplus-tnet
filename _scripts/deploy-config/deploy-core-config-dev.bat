@echo off
title Core Config -> DEV (/www/core-dev/)
cd /d "C:\_Daten\mapplus-exp"
echo.
echo ============================================
echo  CORE CONFIG DEPLOY -- DEV
...
echo.
"C:\Program Files\Python313\python.exe" _scripts\deployment\upload_core_config.py --type %TYPE% --env dev
if errorlevel 1 (
    echo.
