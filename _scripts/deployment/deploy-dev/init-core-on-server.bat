...
if "%CHOICE%"=="1" (
    "%MAPPLUS_PYTHON_EXE%" _scripts\deployment\deployengine\init_core_dev.py
    goto :check_result
)
...
if "%CHOICE%"=="2" (
    ...
    "%MAPPLUS_PYTHON_EXE%" _scripts\deployment\deployengine\init_core_dev.py --overwrite
    goto :check_result
)

if "%CHOICE%"=="3" (
    "%MAPPLUS_PYTHON_EXE%" _scripts\deployment\deployengine\init_core_dev.py --dry-run
    goto :check_result
)
