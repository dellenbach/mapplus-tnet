...
:: nebenwirkungsfreien Dry-Run gibt. Geprueft werden Sync-/js_ori- und Upload-Kandidaten.
...
echo ============================================
echo.
echo [1/2] Promotion Dry-Run (maps-dev -^> maps, js_ori vorbereiten) ...
echo.
...
echo.
"%MAPPLUS_PYTHON_EXE%" _scripts\deployment\deployengine\upload_changed.py --env prod --code-only --dry-run
echo.
