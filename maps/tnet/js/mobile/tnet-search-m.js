    ...
    function panToResult(x, y, zoom, resolution) {
        ...
        waitForKeyboardClose(function () {
            ...
            if (useResolution) {
                ...
                console.log('[MobileSearch] panToResult done, resolution=' + resolution + ' (1:1000) ortho=' + isOrthophotoActive());
            } else {
                ...
                waitForKeyboardClose(function () {
                    ...
                    if (w > 1 || h > 1) {
                        ...
                        if (item.subtitle === 'Adresse') {
                            view.setResolution(_ADDR_RESOLUTION);
                            console.log('[MobileSearch] address res=0.28 (1:1000), center=[' + cx.toFixed(0) + ',' + cy.toFixed(0) + ']');
                        } else {
    ...
    function highlightParcelByCoord(x, y) {
        ...
        xhr.onload = function () {
            ...
            try {
                ...
                console.log('[MobileSearch] Parcel extent:', extent);
                ...
                console.warn('[MobileSearch] Parcel-Geometrie Fehler:', e);
                panToResult(x, y);
            }
        };
        xhr.onerror = xhr.ontimeout = function () {
            console.warn('[MobileSearch] Parcel-Identify Timeout');
            panToResult(x, y);
        };
        xhr.send();
    }
