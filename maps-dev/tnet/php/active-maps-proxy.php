...
$appBasePath = rtrim(str_replace('\\', '/', dirname(dirname(dirname($scriptName)))), '/');
...
$cacheConfig = ['enabled' => false, 'ttlSeconds' => 3600, 'directory' => getProxyCacheDirForAppBase($appBasePath)];
...
$v = time();
$assetBase = ($appBasePath !== '' ? $appBasePath : '') . '/tnet/js';
$jsHelpers = '<script src="' . $assetBase . '/tnet-mapplus-helpers.js?v=' . $v . '"></script>';
$jsInject  = '<script src="' . $assetBase . '/tnet-proxy-inject.js?v=' . $v . '"></script>';
