...
function ensureOerebPanelDOM() {
    ...
    var resizeHandles = isMobile ? '' : (
      ...
      + '<div class="oereb-resize-bottom" id="oereb-resize-bottom"></div>'
      + '<div class="oereb-resize-corner-tl" id="oereb-resize-corner-tl"></div>'
    ...
    panel.innerHTML =
      ...
      +   '</div>'
      + '</div>'
      + '<div id="oereb-selection" class="oereb-selection"></div>'
      + '<div class="oereb-iframe-container">'
